...
| -------------------------------------------------------------------- | -------------- | ----------------------------------------------------------------------------- |
| [2026-08-10_PROPOSAL.html](2026-08-10_PROPOSAL.html)                 | Proposal       | Original case for splitting go-datastar into independently versioned modules  |
| [2026-08-10_EXECUTION_PLAN.html](2026-08-10_EXECUTION_PLAN.html)     | Execution plan | Step-by-step migration from single module to multi-module workspace           |
