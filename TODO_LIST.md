...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ------ | ------ | ---------------------------------------------------------------- |
| Cut the v0.6.0 lockstep release (first `broadcast/` tag): CHANGELOG `[Unreleased]` = broadcast module (2026-09-17) + datastartest helper tranche 2 + CI promotions (nix.yml blocking, fuzz 300s). Green week confirmed by the 2026-09-18 CI-watch ritual; all local gates green 2026-09-18. Follow docs/release-checklist.md (now covers all four modules). | 🔴 `TODO` | Medium | 30min  | CHANGELOG `[Unreleased]`; release checklist; ci-watch 2026-09-18 |
